...
import numpy as np 
import os 
from rescoring_algorithm import find_most_similar_sentence
...
def sinhala_word_inference(filepath):
    classes = ['0_command_spec', '0_spec', '10_command_spec', '10_spec', '11_command_spec', '11_spec', '12_spec', '13_spec', '14_spec', '15_spec', '16_spec', '17_spec', '1_command_spec', '1_spec', '2_command_spec', '2_spec', '3_command_spec', '3_spec', '4_command_spec', '4_spec', '5_command_spec', '5_spec', '6_command_spec', '6_spec', '7_command_spec', '7_spec', '8_command_spec', '8_spec', '9_command_spec', '9_spec']
...
def sentence_preprocess(file_path):
